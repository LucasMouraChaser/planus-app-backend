...
export const INVOICE_FIELDS_CONFIG: FieldConfig[] = [
  ...
  { name: 'item1IcmsPerc',   x: 667, y: 507, width: 48, height: 22, initialValue: "17,00", style: { fontSize: '8px', background: 'white', color: '#000' }, className: "text-right" }, // ICMS Alíquota
  { name: 'item1IcmsRS',     x: 702, y: 507, width: 53, height: 22, initialValue: "277,21", style: { fontSize: '8px', background: 'white', color: '#000' }, className: "text-right" }, // ICMS Valor
