...
export const ENERGISA_INVOICE_FIELDS_CONFIG: FieldConfig[] = [
  ...
  { name: 'item1Valor', x: 350, y: 492, width: 42, height: 16, initialValue: "1.630,64", style: { fontSize: '8px', color: '#000' }, className: "text-right" },
  ...
  { name: 'item2Valor', x: 350, y: 504, width: 42, height: 16, initialValue: "146,60", style: { fontSize: '8px', color: '#000' }, className: "text-right" },
  ...
  { name: 'item3Valor', x: 350, y: 537, width: 42, height: 16, initialValue: "13,75", style: { fontSize: '8px', color: '#000' }, className: "text-right" },
];
