...
export const INVOICE_FIELDS_CONFIG: FieldConfig[] = [
  ...
  { name: 'item1Desc', x: 55, y: 492, width: 132, height: 20, initialValue: "Consumo em kWh", style: { fontSize: '8px', background: 'white' } },
  { name: 'item1Unidade', x: 220, y: 492, width: 37, height: 20, initialValue: "KWH", style: { fontSize: '8px' }, className: "text-center" },
  { name: 'item1Quantidade', x: 245, y: 492, width: 52, height: 20, initialValue: "1.500,00", style: { fontSize: '8px' }, className: "text-right" },
  { name: 'item1Tarifa', x: 275, y: 492, width: 67, height: 20, initialValue: "1,093110", style: { fontSize: '8px' }, className: "text-right" },
  { name: 'item1Valor', x: 330, y: 492, width: 62, height: 20, initialValue: "1.630,64", style: { fontSize: '8px' }, className: "text-right" },
  ...
  { name: 'item2Desc', x: 55, y: 504, width: 132, height: 20, initialValue: "Energia Atv Injetada", style: { fontSize: '8px' } },
  { name: 'item2Tarifa', x: 275, y: 504, width: 67, height: 20, initialValue: "0,847430", style: { fontSize: '8px' }, className: "text-right" },
  { name: 'item2Valor', x: 330, y: 505, width: 62, height: 20, initialValue: "146,60", style: { fontSize: '8px' }, className: "text-right" },
