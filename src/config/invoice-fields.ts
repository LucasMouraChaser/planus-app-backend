...
export const ENERGISA_INVOICE_FIELDS_CONFIG: FieldConfig[] = [
  ...
  { name: 'item1PisValor',   x: 697, y: 479, width: 30, height: 22, initialValue: "14,81", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  ...
  { name: 'item1CofinsValor',x: 697, y: 493, width: 30, height: 22, initialValue: "67,61", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  ...
  { name: 'item1IcmsRS',     x: 697, y: 507, width: 30, height: 22, initialValue: "277,21", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" }, 
