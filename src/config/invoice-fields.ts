...
export const ENERGISA_INVOICE_FIELDS_CONFIG: FieldConfig[] = [
  ...
  { name: 'item1Tarifa', x: 295, y: 492, width: 70, height: 22, initialValue: "1,093110", style: { fontSize: '8px', color: '#000' }, className: "text-right" },
  { name: 'item1Valor', x: 365, y: 492, width: 70, height: 22, initialValue: "1.630,64", style: { fontSize: '8px', color: '#000' }, className: "text-right" },
  ...
  { name: 'item2Tarifa', x: 295, y: 504, width: 70, height: 22, initialValue: "0,847430", style: { fontSize: '8px', color: '#000' }, className: "text-right" },
  { name: 'item2Valor', x: 365, y: 504, width: 70, height: 22, initialValue: "146,60", style: { fontSize: '8px', color: '#000' }, className: "text-right" },
  ...
  { name: 'item3Valor', x: 365, y: 537, width: 70, height: 22, initialValue: "13,75", style: { fontSize: '8px', color: '#000' }, className: "text-right" },
];
