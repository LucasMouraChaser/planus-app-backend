...
export const ENERGISA_INVOICE_FIELDS_CONFIG: FieldConfig[] = [
  ...
  { name: 'item1PisBase',    x: 625, y: 481, width: 35, height: 22, initialValue: "1.353,43", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  { name: 'item1PisAliq',    x: 672, y: 481, width: 30, height: 22, initialValue: "1,0945", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  { name: 'item1PisValor',   x: 713, y: 481, width: 30, height: 22, initialValue: "14,81", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  
  { name: 'item1CofinsBase', x: 625, y: 495, width: 35, height: 22, initialValue: "1.353,43", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  { name: 'item1CofinsAliq', x: 672, y: 495, width: 30, height: 22, initialValue: "4,9955", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  { name: 'item1CofinsValor',x: 713, y: 495, width: 30, height: 22, initialValue: "67,61", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  
  { name: 'item1IcmsBase',   x: 625, y: 509, width: 35, height: 22, initialValue: "1.630,64", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  { name: 'item1IcmsPerc',   x: 672, y: 509, width: 30, height: 22, initialValue: "17,00", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" }, 
  { name: 'item1IcmsRS',     x: 713, y: 509, width: 30, height: 22, initialValue: "277,21", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" }, 
