...
export const INVOICE_FIELDS_CONFIG: FieldConfig[] = [
  // Cabeçalho Energisa
  { name: 'headerTitle', x: 220, y: 15, width: 500, height: 20, initialValue: "SIMULACAO DE FATURA DA ENERGISA", style: { fontSize: '11px', fontWeight: 'bold', color: '#000' } },
  { name: 'companyName', x: 220, y: 25, width: 400, height: 20, initialValue: "ENERGISA MATO GROSSO - DISTRIBUIDORA DE ENERGIA S A", style: { fontSize: '9px', color: '#000' } },
  { name: 'companyAddress', x: 220, y: 35, width: 400, height: 20, initialValue: "Rua Vereador João Barbosa Caramuru, 184", style: { fontSize: '9px', color: '#000' } },
  { name: 'companyCityStateZip', x: 220, y: 45, width: 400, height: 20, initialValue: "Cuiabá/MT - CEP 78010-000", style: { fontSize: '9px', color: '#000' } },
  { name: 'companyCnpj', x: 220, y: 55, width: 160, height: 20, initialValue: "CNPJ XX.XXX.XXX/XXXX-XX", style: { fontSize: '9px', color: '#000' } },
  { name: 'companyInscEst', x: 220, y: 65, width: 180, height: 20, initialValue: "Insc. Est. XXXXXXXXXX", style: { fontSize: '9px', color: '#000' } },

  // Bloco Roteiro/Matrícula (superior esquerdo)
  { name: 'roteiroMatricula', x: 73, y: 105, width: 120, height: 20, initialValue: "655-5432-000-0", style: { fontSize: '9px' }, className: "text-left" },
  { name: 'notaFiscalConcorrencia', x: 208, y: 105, width: 100, height: 20, initialValue: "x", style: { fontSize: '9px' }, className: "text-left" },
  { name: 'domBanco', x: 63, y: 120, width: 120, height: 20, initialValue: "", style: { fontSize: '9px' }, className: "text-left" },
  { name: 'domEnt', x: 208, y: 120, width: 100, height: 20, initialValue: "", style: { fontSize: '9px' }, className: "text-left" },
  ...
  { name: 'dataEmissaoNF', x: 700, y: 191, width: 105, height: 20, initialValue: "18/05/2025", style: { fontSize: '8.5px' }, className: "text-left" },
  ...
  { name: 'qrNFePlaceholder', x: 720, y: 200, width: 70, height: 20, initialValue: "QR NF-e", style: { fontSize: '7px', textAlign:'center' } },
