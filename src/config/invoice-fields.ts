...
export const INVOICE_FIELDS_CONFIG: FieldConfig[] = [
  ...
  { name: 'notaFiscalConcorrencia', x: 208, y: 105, width: 100, height: 15, initialValue: "x", style: { fontSize: '9px' }, className: "text-left" },
  { name: 'domBanco', x: 63, y: 120, width: 120, height: 15, initialValue: "", style: { fontSize: '9px' }, className: "text-left" },
  { name: 'domEnt', x: 208, y: 120, width: 100, height: 15, initialValue: "", style: { fontSize: '9px' }, className: "text-left" },
  
  { name: 'classificacao', x: 73, y: 117, width: 340, height: 24, initialValue: "RESIDENCIAL-CONVENCIONAL BAIXA TENSAO B1/B2/B3", style: { fontSize: '8px' }, className: "text-left" },
  ...
  // Bloco Datas e NF-e (superior direito) - Corrigindo X para valores dentro da área visível
  { name: 'dataApresentacao', x: 700, y: 105, width: 90, height: 18, initialValue: "18/06/2025", style: { fontSize: '9px' }, className: "text-right" }, // HTML x=1000, corrigido para x=700 (visual)
  ...
  { name: 'notaFiscalNum', x: 440, y: 180, width: 105, height: 15, initialValue: "017.270.053", style: { fontSize: '8.5px' }, className: "text-left" }, // HTML x=0, y=0 corrigido
  { name: 'notaFiscalSerie', x: 690, y: 180, width: 45, height: 15, initialValue: "002", style: { fontSize: '8.5px' }, className: "text-left" },
  { name: 'dataEmissaoNF', x: 700, y: 191, width: 105, height: 15, initialValue: "18/05/2025", style: { fontSize: '8.5px' }, className: "text-left" }, // HTML x=1000 corrigido
  { name: 'chaveAcessoNFe', x: 500, y: 218, width: 285, height: 15, initialValue: "5125 0203 4873 2100 0100 5500 2017 2700 5320 8808 7028", style: { fontSize: '8.5px', letterSpacing: '-0.45px' } }, // HTML x=1000 corrigido
  { name: 'contingenciaNFe', x: 500, y: 243, width: 285, height: 15, initialValue: "EMITIDO EM CONTINGÊNCIA Pendente da Autorização", style: { fontSize: '8px' }, className: "text-center" }, // HTML x=1000 corrigido
  { name: 'qrNFePlaceholder', x: 720, y: 200, width: 70, height: 15, initialValue: "QR NF-e", style: { fontSize: '7px', textAlign:'center' } }, // HTML x=1000 corrigido
  ...
  { name: 'mesAnoReferencia', x: 120, y: 348, width: 182, height: 18, initialValue: "MAIO / 2025", style: { fontSize: '11px', fontWeight: 'bold', color: '#000', background: 'transparent' } },
  { name: 'dataVencimento', x: 240, y: 348, width: 102, height: 18, initialValue: "10/07/2025", style: { fontSize: '11px', fontWeight: 'bold', color: '#000', background: 'transparent' } },
  { name: 'valorTotalFatura', x: 340, y: 348, width: 222, height: 22, initialValue: "R$ 1.644,71", style: { fontSize: '16px', fontWeight: 'bold', color: '#000', background: 'transparent' } },
  ...
  { name: 'item1TarifaEnergiaInjetadaREF', x: 565, y: 492, width: 272, height: 16, initialValue: "0,847430", style: { fontSize: '7px', color: '#555' } }, 
  ...
  { name: 'item1IcmsRS', x: 705, y: 512, width: 42, height: 15, initialValue: "277,21", style: { fontSize: '8px' }, className: "text-right" }, // HTML y=361 corrigido para y=512 (visual)
  ...
  { name: 'item2Tarifa', x: 275, y: 504, width: 67, height: 15, initialValue: "0,847430", style: { fontSize: '8px' }, className: "text-right" }, // HTML x=285, y=370 corrigido
  ...
  { name: 'totalPisValor', x: 520, y: 467, width: 42, height: 15, initialValue: "14,81", style: { fontSize: '9px', fontWeight: 'bold' }, className: "text-right" },
  { name: 'totalCofinsValor', x: 665, y: 467, width: 42, height: 15, initialValue: "67,61", style: { fontSize: '9px', fontWeight: 'bold' }, className: "text-right" },
