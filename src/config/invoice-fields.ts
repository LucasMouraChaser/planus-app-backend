...
export const INVOICE_FIELDS_CONFIG: FieldConfig[] = [
  ...
  { name: 'item1PisAliq',    x: 679, y: 479, width: 48, height: 22, initialValue: "1,0945", style: { fontSize: '8px', background: 'white' }, className: "text-right" },
  { name: 'item1PisValor',   x: 714, y: 479, width: 53, height: 22, initialValue: "14,81", style: { fontSize: '8px', background: 'white' }, className: "text-right" },
  
  // Campos de Tributos - COFINS (Linha 1)
  { name: 'item1CofinsBase', x: 629, y: 493, width: 63, height: 22, initialValue: "1.353,43", style: { fontSize: '8px', background: 'white' }, className: "text-right" },
  { name: 'item1CofinsAliq', x: 679, y: 493, width: 48, height: 22, initialValue: "4,9955", style: { fontSize: '8px', background: 'white' }, className: "text-right" },
  { name: 'item1CofinsValor',x: 714, y: 493, width: 53, height: 22, initialValue: "67,61", style: { fontSize: '8px', background: 'white' }, className: "text-right" },
  
  // Campos de Tributos - ICMS (Linha 1)
  { name: 'item1IcmsBase',   x: 629, y: 507, width: 63, height: 22, initialValue: "1.630,64", style: { fontSize: '8px', background: 'white' }, className: "text-right" },
  { name: 'item1IcmsPerc',   x: 679, y: 507, width: 48, height: 22, initialValue: "17,00", style: { fontSize: '8px', background: 'white' }, className: "text-right" }, // ICMS Alíquota
  { name: 'item1IcmsRS',     x: 714, y: 507, width: 53, height: 22, initialValue: "277,21", style: { fontSize: '8px', background: 'white' }, className: "text-right" }, // ICMS Valor
