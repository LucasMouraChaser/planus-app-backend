...
export const ENERGISA_INVOICE_FIELDS_CONFIG: FieldConfig[] = [
  ...
  { name: 'item1PisBase',    x: 620, y: 479, width: 63, height: 22, initialValue: "1.353,43", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  { name: 'item1PisAliq',    x: 667, y: 479, width: 48, height: 22, initialValue: "1,0945", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  { name: 'item1PisValor',   x: 702, y: 479, width: 53, height: 22, initialValue: "14,81", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  
  { name: 'item1CofinsBase', x: 624, y: 493, width: 63, height: 22, initialValue: "1.353,43", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  { name: 'item1CofinsAliq', x: 667, y: 493, width: 48, height: 22, initialValue: "4,9955", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  { name: 'item1CofinsValor',x: 702, y: 493, width: 53, height: 22, initialValue: "67,61", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  
  { name: 'item1IcmsBase',   x: 624, y: 507, width: 63, height: 22, initialValue: "1.630,64", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  { name: 'item1IcmsPerc',   x: 667, y: 507, width: 48, height: 22, initialValue: "17,00", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" }, 
  { name: 'item1IcmsRS',     x: 702, y: 507, width: 53, height: 22, initialValue: "277,21", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" }, 
