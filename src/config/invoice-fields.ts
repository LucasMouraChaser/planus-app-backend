...
export const ENERGISA_INVOICE_FIELDS_CONFIG: FieldConfig[] = [
  ...
  { name: 'item1Tarifa', x: 283, y: 492, width: 70, height: 22, initialValue: "1,093110", style: { fontSize: '8px', color: '#000' }, className: "text-right" },
  { name: 'item1Valor', x: 361, y: 492, width: 42, height: 16, initialValue: "1.630,64", style: { fontSize: '8px', color: '#000' }, className: "text-right" },
  ...
  { name: 'item1PisAliq',    x: 672, y: 479, width: 30, height: 22, initialValue: "1,0945", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  ...
  { name: 'item1CofinsAliq', x: 672, y: 493, width: 30, height: 22, initialValue: "4,9955", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" },
  ...
  { name: 'item1IcmsPerc',   x: 672, y: 507, width: 30, height: 22, initialValue: "17,00", style: { fontSize: '7px', background: 'white', color: '#000' }, className: "text-right" }, 
  ...
  { name: 'item2Tarifa', x: 283, y: 504, width: 70, height: 22, initialValue: "0,847430", style: { fontSize: '8px', color: '#000' }, className: "text-right" },
  { name: 'item2Valor', x: 361, y: 504, width: 42, height: 16, initialValue: "146,60", style: { fontSize: '8px', color: '#000' }, className: "text-right" },
  ...
  { name: 'item3Valor', x: 361, y: 537, width: 42, height: 16, initialValue: "13,75", style: { fontSize: '8px', color: '#000' }, className: "text-right" },
];
