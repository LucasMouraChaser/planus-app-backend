...
export const INVOICE_FIELDS_CONFIG: FieldConfig[] = [
  ...
  { name: 'item1PisBase',    x: 597, y: 487, width: 60, height: 22, initialValue: "1.353,43", style: { fontSize: '8px' }, className: "text-right" },
  { name: 'item1PisAliq',    x: 657, y: 487, width: 45, height: 22, initialValue: "1,0945", style: { fontSize: '8px' }, className: "text-right" },
  { name: 'item1PisValor',   x: 702, y: 487, width: 50, height: 22, initialValue: "14,81", style: { fontSize: '8px' }, className: "text-right" },
  
  // Campos de Tributos - COFINS (Linha 1)
  { name: 'item1CofinsBase', x: 597, y: 498, width: 60, height: 22, initialValue: "1.353,43", style: { fontSize: '8px' }, className: "text-right" },
  { name: 'item1CofinsAliq', x: 657, y: 498, width: 45, height: 22, initialValue: "4,9955", style: { fontSize: '8px' }, className: "text-right" },
  { name: 'item1CofinsValor',x: 702, y: 498, width: 50, height: 22, initialValue: "67,61", style: { fontSize: '8px' }, className: "text-right" },
  
  // Campos de Tributos - ICMS (Linha 1)
  { name: 'item1IcmsBase',   x: 597, y: 509, width: 60, height: 22, initialValue: "1.630,64", style: { fontSize: '8px' }, className: "text-right" },
  { name: 'item1IcmsPerc',   x: 657, y: 509, width: 45, height: 22, initialValue: "17,00", style: { fontSize: '8px' }, className: "text-right" },
  { name: 'item1IcmsRS',     x: 702, y: 509, width: 50, height: 22, initialValue: "277,21", style: { fontSize: '8px' }, className: "text-right" },
