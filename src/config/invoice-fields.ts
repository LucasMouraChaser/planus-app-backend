...
export const INVOICE_FIELDS_CONFIG: FieldConfig[] = [
  ...
  { name: 'classificacao', x: 73, y: 117, width: 240, height: 15, initialValue: "RESIDENCIAL-CONVENCIONAL BAIXA TENSAO B1/B2/B3", style: { fontSize: '8px' }, className: "text-left" },
  ...
  { name: 'chaveAcessoNFe', x: 500, y: 218, width: 285, height: 15, initialValue: "5125 0203 4873 2100 0100 5500 2017 2700 5320 8808 7028", style: { fontSize: '8.5px', letterSpacing: '-0.45px' } },
  { name: 'contingenciaNFe', x: 500, y: 243, width: 285, height: 15, initialValue: "EMITIDO EM CONTINGÊNCIA Pendente da Autorização", style: { fontSize: '8px' }, className: "text-center" },
  ...
  { name: 'item1IcmsRS', x: 710, y: 361, width: 42, height: 15, initialValue: "277,21", style: { fontSize: '8px' }, className: "text-right" },
  ...
  { name: 'item2Tarifa', x: 285, y: 370, width: 67, height: 15, initialValue: "0,847430", style: { fontSize: '8px' }, className: "text-right" },
