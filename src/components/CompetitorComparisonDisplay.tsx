...
const CompetitorComparisonDisplay: FC<CompetitorComparisonDisplayProps> = ({ currentBillAmount, sentEnergyAnnualSaving }) => {
  ...
  return (
    <Card className="shadow-lg transition-all duration-300 ease-out mt-8">
      <CardHeader>
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {competitorsData.map((competitor) => {
            ...
            return (
              <div key={competitor.id} className="p-4 bg-card rounded-lg border shadow-sm hover:shadow-md transition-shadow duration-300 ease-out space-y-3 flex flex-col">
